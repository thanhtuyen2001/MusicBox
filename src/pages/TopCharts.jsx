...
import { Error, Loader, MusicPlayer, SongCard, TopPlay, LoveBtn } from '../components';
...
const TopCharts = () => {
  ...
  return (
    <div className="p-12">
      {/* img */}
      <div className="w-90%  h-80 flex rounded-lg mb-8  overflow-hidden bg-star ">
      ...
      <div>
        {data.map((song, i) => (
          <div key={i} className="flex items-center justify-between gap:2 md:gap-4 hover:bg-[#344b6b] dark:hover:bg-slate-200 m-4 p-2 rounded-md">
            <div className="flex justify-center items-center gap-2 ">
              <div className={`font-Roboto stroke text-[3em] flex-shrink-0  ${i === 0 ? 'strokeTop1' : i === 1 ? 'strokeTop2' : i === 2 ? 'strokeTop3' : ''} `}> {i < 9 ? `0${i + 1}` : `${i + 1}`} - 
              </div>
      ...
      <div className=" text-center">
        <button className="border-2 py-2 px-4 rounded-full hover:bg-[#344b6b]">
